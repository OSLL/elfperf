...
:_ZN12QPainterPath7addTextERK7QPointFRK5QFontRK7QString\
...
:_ZN8QPainter11drawEllipseERK5QRect\
...
:_ZNK5QRectorERKS_\
:_ZNK6QImage4sizeEv\
:_ZNK6QLineF10unitVectorEv\
:_ZNK6QLineF6isNullEv\
...
:_ZdlPv\
:_ZmlRK12QPainterPathRK7QMatrix\
:_Znwm\
:__cxa_atexit\
:__cxa_begin_catch\
:__cxa_end_catch\
...
:__libc_start_main\
:memcpy  /tools/lib/ld-2.11.3.so ./deform'
