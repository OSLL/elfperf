...
bash -c 'make test_redir_cdecl_32 run_test_redir clean' 2>/dev/null 1>/dev/null 
...
bash -c 'make test_redir_no_cdecl_32 run_test_redir clean' 2>/dev/null 1>/dev/null
...
bash -c 'make test_redir_cdecl_64 run_test_redir clean' 2>/dev/null 1>/dev/null 
...
bash -c 'make test_redir_no_cdecl_64 run_test_redir clean' 2>/dev/null 1>/dev/null
